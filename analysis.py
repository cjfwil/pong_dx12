...
def generate_report(cppcheck, msvc, lizard):
    ...
    # Cppcheck section
    report_lines.append("## 🔍 Cppcheck\n")
    cppcheck_success, cppcheck_out, cppcheck_err = cppcheck
    report_lines.append(f"- **Status:** {'✅ Success' if cppcheck_success else '❌ Failed'}\n")
    ...
    report_lines.append("## 🛠️ MSVC /analyze\n")
    msvc_success, msvc_out, msvc_err = msvc
    report_lines.append(f"- **Status:** {'✅ Success' if msvc_success else '❌ Failed'}\n")
    ...
    # Lizard section
    report_lines.append("## 🦎 Lizard (Complexity)\n")
    lizard_success, lizard_out, lizard_err = lizard
    report_lines.append(f"- **Status:** {'✅ Success' if lizard_success else '❌ Failed'}\n")
    if lizard_out.strip():
        report_lines.append("\n**Complexity report:**\n")
        report_lines.append("```\n" + lizard_out.strip() + "\n```\n")
    if lizard_err.strip():
